        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 bordure">
                ...
                <div class="form-group row m-2">
                    ...
                    <input type="email" class="form-control" name="email" id="email" placeholder="Votre adresse email" value="<?php echo $email; ?>">
                    <p class="error"><?php echo $emailError ?></p>
                </div>
                <div class="form-group row m-2">
                    <label for="message">Message</label>
                    <textarea class="form-control" name="message" id="message" cols="50" rows="5" placeholder="Votre message"><?php echo $msg; ?></textarea>
